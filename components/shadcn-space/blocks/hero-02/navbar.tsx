...
const NavLink: React.FC<NavLinkProps> = ({
  ...
  return (
    <li className="flex items-center group w-fit cursor-pointer">
      <div className={`h-0.5 bg-primary transition-all duration-300 ${item.isActive ? 'w-4 mr-2' : 'w-0 group-hover:w-4 group-hover:mr-2'}`} />
      <a
        href={item.href}
        className={`text-lg font-medium rounded-full transition-colors ${item.isActive ? 'text-primary' : "text-muted-foreground group-hover:text-primary"}`}
      >
        {item.name}
      </a>
    </li>
          ...
          <div className='flex justify-between items-center gap-2 w-full'>
            <div>
              <a href='#' className="flex items-center gap-2">
                ...
                <span className={`font-semibold ${sticky ? "text-black":"text-white"}`}>Prime Nest</span>
              </a>
            </div>
          ...
          >
            ...
            <div className="flex flex-col gap-12 text-foreground">
              ...
              <div className="flex flex-col gap-1">
                <p className="text-medium font-normal text-muted-foreground">
                  Contact
                </p>
                <a href="#" className="text-base font-medium hover:text-primary flex gap-2.5 items-center">
                  <Mail size={16}></Mail> info@primenest.com
                </a>
                <a href="#" className="text-base font-medium hover:text-primary flex gap-2.5 items-center">
                  <Phone size={16}></Phone>+254-712-456-789
                </a>
              </div>
              ...
              <div className="flex flex-col gap-1">
                ...
                <a href="#" className="text-base font-medium hover:text-primary flex gap-2.5 items-center">
                  <Twitter size={20}></Twitter>Twitter
                </a>
                <a href="#" className="text-base font-medium hover:text-primary flex gap-2.5 items-center">
                  <Facebook size={20}></Facebook>Facebook
                </a>
                <a href="#" className="text-base font-medium hover:text-primary flex gap-2.5 items-center">
                  <Instagram size={20}></Instagram>Instagram
                </a>
              </div>
            </div>
          </SheetContent>
