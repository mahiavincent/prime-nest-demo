export default function HeroSection() {
    return (
        <>
            ...
            `}</style>
            <section className="flex flex-col items-center pb-48 text-center text-sm text-white max-md:px-2 bg-[url('https://i.pinimg.com/736x/0c/c5/0c/0cc50c1db7290443b6b3c3d59dc73718.jpg')] bg-cover opacity-80 bg-center w-full">
